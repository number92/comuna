...
<EntityHeader
  ...
  name={$t('routes.profile.welcome', {
    default: data.my_user?.local_user_view.person.display_name || data.my_user?.local_user_view.person.name,
  })}
  stats={[
    {
...
<div class="grid grid-cols-1 gap-4">
  <a href="/profile/password/2fa">
    <Material
      class="hover:ring-primary-900 dark:hover:ring-primary-100 hover:ring-2 transition-all
      flex flex-col gap-2 h-full"
      rounding="2xl"
    >
      <Material rounding="full" padding="sm" color="default" class="h-max w-max">
  ...
  <a href="/profile/password/logins">
    <Material
      class="hover:ring-primary-900 dark:hover:ring-primary-100 hover:ring-2 transition-all
      flex flex-col gap-2 h-full"
      rounding="2xl"
  ...
  <a href="/profile/password/delete">
    <Material
