...
>
  <Tabs
    class="overflow-auto"
    routes={[
      { href: '/profile', name: $t('routes.profile.overview') },
      { href: '/profile/user', name: $t('routes.profile.submissions') },
      { href: '/profile/settings', name: $t('routes.profile.settings') },
      { href: '/profile/blocks', name: $t('routes.profile.blocks.title') },
      { href: '/profile/password', name: $t('routes.profile.credentials') },
    ]}
  />
